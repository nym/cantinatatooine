describe('App', () => {
  ...
  it('List view should include name, gender, and home planet', () => {
    ...
    cy.get('.personListItem').contains('Films: A New Hope, The Empire Strikes Back, Return of the Jedi, Revenge of the Sith')
  ...
  it('Detail should include name, hair colour, eye colour, homeworld, and films the character has appeared in', () => {
    ...
    cy.get('.personDetailPage').contains('Films: A New Hope, The Empire Strikes Back, Return of the Jedi, The Phantom Menace, Attack of the Clones, Revenge of the Sith')
  })
})
